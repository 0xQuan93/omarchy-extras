  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      Rectangle {
        ...
        color: closeMouse.containsMouse ? Qt.lighter(Color.notifications.background, 1.5) : "transparent"
        ...
        border.color: Color.notifications.text
        ...
        Text {
          ...
          color: closeMouse.containsMouse ? Color.notifications.text : root.dimColor
        }
